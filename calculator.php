...
<?php
if (isset($_POST['nombre1']) AND isset($_POST['choix']) AND isset($_POST['nombre2'])) // On vérifie si les variables existent ...
    {
    ...
    if ($nombre1 != NULL AND $nombre2 != NULL) // Puis on vérifie leur valeur ...
        ...
        if ($choix == division AND $nombre2 == 0) {
            ...
            if ($choix == soustraction) // Si on a choisi la soustraction, on calcule la différence.
                {
                $resultat = $nombre1 - $nombre2; // On calcule
